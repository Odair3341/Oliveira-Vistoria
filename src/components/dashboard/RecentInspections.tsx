          ...
          >
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-foreground">
                {(inspection.total !== undefined && inspection.total !== null && !isNaN(Number(inspection.total)) && Number(inspection.total) > 0) ? `R$ ${Number(inspection.total).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}` : '-'}
              </p>
